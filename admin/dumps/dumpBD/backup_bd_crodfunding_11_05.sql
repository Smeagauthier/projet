...
-- Started on 2021-05-11 16:01:44
...
--
-- TOC entry 2152 (class 0 OID 113843)
-- Dependencies: 190
...
--
-- TOC entry 2150 (class 0 OID 113834)
-- Dependencies: 188
-- Data for Name: cf_client; Type: TABLE DATA; Schema: public; Owner: -
--

INSERT INTO public.cf_client (id_client, nom_client, prenom_client, tel, pseudo, password, email) VALUES (1, 'Rigaux', 'Gauthier', '0472644893', 'Atomix', 'ok', 'rigauxgauthier@gmail.com');
INSERT INTO public.cf_client (id_client, nom_client, prenom_client, tel, pseudo, password, email) VALUES (19, 'Rigaux', 'Gauthier', '0472644893', 'Randaz', 'randaz', 'rigauxgauthier@gmail.com');
INSERT INTO public.cf_client (id_client, nom_client, prenom_client, tel, pseudo, password, email) VALUES (20, 'Rigaux', 'Gauthier', '0472644893', 'Rdz', 'rdz', 'rigauxgauthier@gmail.com');
INSERT INTO public.cf_client (id_client, nom_client, prenom_client, tel, pseudo, password, email) VALUES (21, 'Rigaux', 'Gauthier', '0472644893', 'Araknas', 'araknas', 'rigauxgauthier@gmail.com');
INSERT INTO public.cf_client (id_client, nom_client, prenom_client, tel, pseudo, password, email) VALUES (22, 'Samaras', 'Ken', '0476/89/79/80', 'Nekfeu', 'nekfeu', 'nekfeu@gmail.com');


--
-- TOC entry 2148 (class 0 OID 113823)
-- Dependencies: 186
...
INSERT INTO public.cf_projet (id_projet, nom_projet, description, image, proprietaire, reference, objectif, temps) VALUES (1, 'Team Trees', 'Fondation Team Trees qui se bat pour l environnement et la déforestation ! 1€ de don vaut 1 arbre planté.', 'team_trees.svg.png', 'MrBeast', 'A1', '15 000 €
', 'Pas de limite
');
...
SELECT pg_catalog.setval('public.cf_client_id_client_seq', 22, true);
...
SELECT pg_catalog.setval('public.cf_projet_id_projet_seq', 12, true);


-- Completed on 2021-05-11 16:01:47
